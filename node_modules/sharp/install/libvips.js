...
const agent = require('sharp/lib/agent');
const libvips = require('sharp/lib/libvips');
...
try {
  ...
  if (useGlobalLibvips) {
    ...
    const supportedNodeVersion = process.env.npm_package_engines_node || require('sharp/package.json').engines.node;
